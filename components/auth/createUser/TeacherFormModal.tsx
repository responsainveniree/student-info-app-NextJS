                        ...
                        <div className="border rounded-xl p-6 bg-gradient-to-br from-gray-50 to-white">
                            ...
                            <div className="relative group">
                                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 hover:border-green-400 transition-all text-center">
                                    <label htmlFor="teacher-excel-file" className="flex flex-col items-center cursor-pointer">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="border-t pt-6">
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-lg font-bold text-gray-800">Homeroom Class (Optional)</h3>
                                    <Button type="button" variant="destructive" size="sm" onClick={clearHomeroomClass}>
                                ...
                                <div className="grid md:grid-cols-3 gap-4">
                                    <Select
                                        onValueChange={(v) => setHomeroomClass({ ...homeroomClass, grade: v })}
                                    ...
                                    <Select
                                        onValueChange={(v) => setHomeroomClass({ ...homeroomClass, major: v })}
                                    ...
                                    <Select
                                        onValueChange={(v) => setHomeroomClass({ ...homeroomClass, classNumber: v })}
                            ...
                            <div className="border-t pt-6">
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-lg font-bold text-gray-800">Teaching Classes (Optional)</h3>
                                    <Button
                                        type="button"
                                    ...
                                    {teachingClasses.map((tc, index) => (
                                        <div key={index} className="bg-gray-50 p-4 rounded-lg border">
                                            <div className="flex items-center justify-between mb-3">
                                                <span className="font-semibold text-gray-700">Class #{index + 1}</span>
                                                <Button
                                                    type="button"
                                                    variant="destructive"
                                                    size="sm"
                                            ...
                                            <div className="grid md:grid-cols-3 gap-3">
                                                <Select
                                                    onValueChange={(v) => updateTeachingClass(index, "grade", v)}
                                                    value={tc.grade}
                                                    disabled={loading}
                                                >
                                                    <SelectTrigger className="h-11">
                                                ...
                                                <Select
                                                    onValueChange={(v) => updateTeachingClass(index, "major", v)}
                                                    value={tc.major}
                                                    disabled={loading}
                                                >
                                                    <SelectTrigger className="h-11">
                                                ...
                                                <Select
                                                    onValueChange={(v) => updateTeachingClass(index, "classNumber", v)}
                            ...
                            <div className="border-t pt-6">
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-lg font-bold text-gray-800">Teaching Assignments (Optional)</h3>
                                    <Button
                                        type="button"
                                ...
                                <div className="space-y-3">
                                        ...
                                        <div key={index} className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                                            <div className="flex items-center justify-between mb-3">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="font-semibold text-gray-700">Assignment #{index + 1}</span>
                                                </div>
                                                <Button
                                                    type="button"
                                                    variant="destructive"
                                            ...
                                            <div className="space-y-3">
                                                <Select
                                                    onValueChange={(v) => updateTeachingAssignment(index, "subjectName", v)}
                                                        ...
                                                        {Object.entries(sortedAndGroupedSubjects).map(
                                                            ([categoryName, subjectKeysArray]) => (
                                                                <SelectGroup key={categoryName}>
                                                                    ...
                                                                    {subjectKeysArray.map((subjectKey: string) => (
                                                ...
                                                <div className="grid md:grid-cols-3 gap-3">
                                                    <Select
                                                        onValueChange={(v) => updateTeachingAssignment(index, "grade", v)}
                                                        value={ta.grade}
                                                        disabled={loading}
                                                    >
                                                        <SelectTrigger className="h-11 bg-white">
                                                    ...
                                                    <Select
                                                        onValueChange={(v) => updateTeachingAssignment(index, "major", v)}
                                                        value={ta.major}
                                                        disabled={loading}
                                                    >
                                                        <SelectTrigger className="h-11 bg-white">
                                                    ...
                                                    <Select
                                                        onValueChange={(v) => updateTeachingAssignment(index, "classNumber", v)}
                                    ...
                                    {teachingAssignments.length === 0 && (
                                        <p className="text-center py-4 text-gray-500">
                                            No teaching assignments added. Click "Add Assignment" to add one.
                                        </p>
                                    )}
                                </div>
                            </div>
