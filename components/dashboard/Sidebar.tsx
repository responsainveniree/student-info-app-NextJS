...
export const Sidebar = ({ role, isHomeroomClassTeacher }: SidebarProps) => {
    ...
    const getNavItems = (currentRole?: string) => {
        ...
        switch (currentRole) {
            ...
            case ROLES.STUDENT:
                return [
                    { href: "/student-dashboard", icon: BookOpen, label: "Dashboard" },
            ...
            case ROLES.CLASS_SECRETARY:
                return [
                    { href: "/student-dashboard", icon: BookOpen, label: "Dashboard" },
                    { href: "/student-dashboard/attendance", icon: ClipboardCheck, label: "Attendance" },
                    { href: "#", icon: TrendingUp, label: "Grades" },
                    ...commonItems
                ];
    ...
    const getPortalTitle = (currentRole?: string) => {
        switch (currentRole) {
            ...
            case ROLES.VICE_PRINCIPAL:
            case ROLES.PRINCIPAL: return "Staff Portal";
